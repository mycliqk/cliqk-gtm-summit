...
const initialMarketers: Marketer[] = [
  { id: "1", name: "Roy Lee", company: "Cluely", role: "Founder", status: "available", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/IMG_0542-cd7HEvMa8uHDjcMLFqM5XsJVvCNzMH.jpeg" },
  ...
  { id: "5", name: "Sean Hargrow", company: "Series", role: "Founder", status: "available", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-PTBC2Bys5I9voxPegxHHsvvdim2fzw.png" },
  ...
  { id: "29", name: "Sheel Shah", company: "Startup", role: "Head of Growth", status: "available", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/9-puIWsTFj1vL1kG3e8NfZRl94d9YWu5.png" },
  { id: "30", name: "Emily Lonetto", company: "Vizcom", role: "Head of Marketing", status: "available", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/10-sXh3qJTimOsqKACWfAqCBFLZ16hGss.png" },
  ...
  { id: "38", name: "Natalie Riso", company: "Rho", role: "Marketing", status: "available", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-GnNKa2bDeAlFiRK5G7deg2qwuFJDAr.png" },
  { id: "39", name: "David Wu", company: "Phantom", role: "Head of Growth", status: "available", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-IQniyVwbLk14qZu4nBAlX9UHNB2TzZ.png" },
  ...
  { id: "51", name: "Andrew Yeung", company: "Fibe", role: "Founder", status: "available", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Andrew%20Yeung-WTzNKapLch2YXQqajBkbj2QHar1nBd.png" },
  { id: "52", name: "Max Marchione", company: "Superpower", role: "Founder", status: "available", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-xzpsK9smhN5VVdI4lBH9wZpsL26kG7.png" },
  ...
  { id: "55", name: "Jaiya Gill", company: "Carry", role: "Marketing", status: "available", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Jaiya%20Gill-NnvHDNLTGyD9IcmaCWK8CHkc4Q6NQL.png" },
  { id: "56", name: "Ankur Nagpal", company: "Silly Money", role: "Founder", status: "available", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-dIB6FWOzmQmtKH46Ph9liA0ZmAVQna.png" },
  { id: "57", name: "Austin Rief", company: "Morning Brew", role: "Co-Founder", status: "available", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-4Fut6K80kCOjoCQhPgKlRkgWV3I8Sm.png" },
  ...
  { id: "91", name: "Tarek Mansour", company: "Kalshi", role: "Founder", status: "available", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-N31YmhaIKOZeV77MBkoJpIputMEYsU.png" },
  { id: "92", name: "Paulina Westermann", company: "Taktile", role: "Founder", status: "available", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-vYWOSbpoyziYMWroRbL2jAbzhyskPA.png" },
  ...
  { id: "97", name: "Nathan Allebach", company: "Ramp", role: "Social Media Lead", status: "available" },
  ...
  { id: "116", name: "Phoebe Gates", company: "Phia", role: "Founder", status: "available" },
  { id: "117", name: "Sophia Kianni", company: "Phia", role: "Founder", status: "available" },
];
          ...
          <div className="relative w-full sm:max-w-lg bg-zinc-950 border-t sm:border border-zinc-800/50 rounded-t-2xl sm:rounded-2xl p-6 sm:p-10 shadow-2xl animate-slide-up-modal max-h-[90vh] overflow-y-auto">
            ...
            <div className="mb-8 sm:mb-10">
              ...
              <p className="text-white/50 text-sm sm:text-base leading-relaxed">
                The top 107 marketers in tech. Your $500 ticket is covered. Find your name, claim your spot.
              </p>
            </div>
            ...
            <div className="mt-8 flex items-center justify-between">
              ...
              <span className="text-white/20 text-[10px] sm:text-xs tracking-wide">107 spots</span>
            </div>
          </div>
        </div>
      )}
